...
export async function GET(req: Request) {
  try {
    ...
    console.error("Fout in GET /api/notities:", error);
    return NextResponse.json(
      { error: "Fout bij ophalen notities" },
      { status: 500 }
    );
  }
}
...
export async function POST(req: Request) {
  try {
    ...
    console.error("Fout in POST /api/notities:", error);
    return NextResponse.json(
      { error: "Fout bij opslaan notitie" },
      { status: 500 }
    );
  }
}
...
export async function PATCH(req: Request) {
  try {
    ...
    console.error("Fout in PATCH /api/notities:", error);
    return NextResponse.json(
      { error: "Fout bij bijwerken notitie" },
      { status: 500 }
    );
  }
}
...
export async function DELETE(req: Request) {
  try {
    ...
    console.error("Fout in DELETE /api/notities:", error);
    return NextResponse.json(
      { error: "Fout bij verwijderen notitie" },
      { status: 500 }
    );
  }
}