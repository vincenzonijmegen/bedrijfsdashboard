...
function medewerkerFuncties(medewerker: any): string[] {
  ...
  // Avond-scheppers krijgen ook algemene schepper-overdag instructies.
  // Andersom niet.
...
async function haalTeVersturenOpdrachten() {
    ...
    <div style="margin:0; padding:0; background:#f1f5f9; font-family:Arial, sans-serif; color:#0f172a;">
      <div style="max-width:720px; margin:0 auto; padding:24px;">
        <div style="background:#ffffff; border:1px solid #e2e8f0; border-radius:18px; padding:24px;">
          <p style="margin:0 0 12px 0; color:#475569;">Hallo ${opdracht.medewerker_naam || ""},</p>
...
export async function POST(req: NextRequest) {
  try {
    ...
    const resultaat = await verstuurVolgende(req);
