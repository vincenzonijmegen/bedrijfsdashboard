...
const rapportages = [
  ...
  {
    titel: 'Salariscontrole verjaardagen',
    beschrijving: 'Toon welke jonge medewerkers vorige maand jarig waren en mogelijk een nieuw bruto loon moeten krijgen.',
    link: '/admin/rapportage/verjaardagen',
  },
