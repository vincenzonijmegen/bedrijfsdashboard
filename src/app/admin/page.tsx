    ...
    <main className="min-h-screen bg-slate-100 px-6 py-6">
      <div className="mx-auto max-w-7xl">
        ...
        <Section id="personeel" title="👥 Personeel & opleiding" color="green" activeSection={activeSection} setActiveSection={setActiveSection}>
          ...
          <LinkCard href="/admin/rapportage/verjaardagen" label="Salariscontrole verjaardagen" color="green" Icon={PartyPopper} breadcrumb="Personeel & opleiding – Salariscontrole verjaardagen" />
        ...
        <Section id="planning" title="📅 Planning & bezetting" color="orange" activeSection={activeSection} setActiveSection={setActiveSection}>
          ...
          <LinkCard href="/admin/shiftbase/rooster-backup" label="Roosterbackup" color="orange" Icon={Archive} breadcrumb="Planning & bezetting – Roosterbackup" />
