...
function formatDateWithDay(value: string) {
  const d = new Date(`${value}T00:00:00`);
  return `${dagen[d.getDay()]} ${d.toLocaleDateString("nl-NL")}`;
}
...
export default function GespreksdocumentPage({
  ...
  return (
    <main className="mx-auto max-w-5xl space-y-4 p-6 print:max-w-none print:p-0">
      ...
      <div className="rounded-xl border bg-white p-6 text-sm print:border-0 print:p-0">
            ...
            <table className="w-full border-collapse text-center text-sm">
              ...
              <tbody>
                {[
                  ...
                  const momenten: string[] = data.beschikbaar_momenten || [];
        ...
        <section className="mt-4 rounded-lg border p-3">
          ...
          <div className="grid gap-x-6 gap-y-1 md:grid-cols-2 print:grid-cols-2">
            {feestdagen.map((f) => (
              <div key={f.label}>
